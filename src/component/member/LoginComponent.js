  ...
  return (
    <div className="flex h-screen min-h-[210px] flex-col items-center justify-center">
      ...
      <div className="mb-5 flex gap-10">
        <div className="px-6 py-3 rounded-2xl border-2 border-neutral-800 bg-neutral-800 text-white font-semibold cursor-pointer transition">개인</div>
        <Link to="/login/seller" className="px-6 py-3 rounded-2xl border-2 border-neutral-800 bg-white text-neutral-800 font-semibold cursor-pointer transition hover:bg-neutral-100">
          사업자
        </Link>
      </div>
...
<div className="mt-5 flex w-72 flex-col gap-2 items-center">
  <GoogleLoginApi className="w-full" />
  <KakaoLoginAPI className="w-full" />
  <NaverLoginAPI className="w-full" />
</div>
